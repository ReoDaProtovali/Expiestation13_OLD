...
#define OVERMIND_MAX_CAMERA_STRAY "5x5" // How far the overmind camera is allowed to stray from blob tiles. 3x3 is 1 tile away, 5x5 2 tiles etc
...
#define BLOB_ATTACK_REFUND 3 // Points 'refunded' when the expand attempt actually attacks something instead
...
#define BLOB_EXPAND_CHANCE_MULTIPLIER 1.5 // Increase this value to make blobs naturally expand faster
...
#define BLOB_NODE_STRONG_REINFORCE_RANGE 1 // The radius of tiles surrounding the node that get upgraded
#define BLOB_NODE_REFLECTOR_REINFORCE_RANGE 0

#define BLOB_FACTORY_MAX_HP 200
#define BLOB_FACTORY_HP_REGEN 1
#define BLOB_FACTORY_MIN_DISTANCE 5 // Minimum distance between factories
#define BLOB_FACTORY_MAX_SPORES 5
...
#define BLOB_RESOURCE_GATHER_DELAY (6 SECONDS) // Gather points when pulsed outside this interval
#define BLOB_RESOURCE_GATHER_ADDED_DELAY (0.25 SECONDS) // Every additional resource blob adds this amount to the gather delay
#define BLOB_RESOURCE_GATHER_AMOUNT 2 // The amount of points added to the overmind
...
#define BLOB_STRONG_HP_REGEN 5

#define BLOB_REFLECTOR_MAX_HP 250
#define BLOB_REFLECTOR_HP_REGEN 0

// Structure purchasing

#define BLOB_UPGRADE_STRONG_COST 5 // Upgrade and build costs here
...
#define BLOB_POWER_RELOCATE_COST 100 // Resource cost to move your core to a different node
#define BLOB_POWER_REROLL_COST 40 // Strain reroll
#define BLOB_POWER_REROLL_FREE_TIME (3 MINUTES) // Gain a free strain reroll every x minutes
...
#define BLOBMOB_BLOBBERNAUT_REAGENTATK_VOL 25 // Amounts of strain reagents applied on attack -- basically the main damage stat
#define BLOBMOB_BLOBBERNAUT_DMG_OBJ 60 // Damage dealth to objects/machines
#define BLOBMOB_BLOBBERNAUT_HEALING_CORE 0.075 // Percentage multiplier HP restored on Life() when within 2 tiles of the blob core
