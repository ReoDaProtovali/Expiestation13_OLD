...
/proc/init_sprite_accessories()
	...
	init_sprite_accessory_subtypes(/datum/sprite_accessory/tails/experiment, GLOB.tails_list_experiment, add_blank = TRUE) //Expiestation Addition
	init_sprite_accessory_subtypes(/datum/sprite_accessory/experiment_headspikes, GLOB.headspikes_list_experiment) //Expiestation Addition
